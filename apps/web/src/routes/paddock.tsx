...
const CRON_TRIGGERS: CronTrigger[] = [
  { label: "Warm (12:45 daily)", cron: "45 12 * * *", hint: "Refresh union-universe factors — runs every day incl. weekends. Takes 50-90s; waits for completion before responding so it doesn't orphan in waitUntil.", mode: "sync" },
